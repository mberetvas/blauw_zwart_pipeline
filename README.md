...
**Synthetic events:** Run `python scripts/generate_fan_events.py` from the repo root (see [`specs/001-synthetic-fan-events/quickstart.md`](specs/001-synthetic-fan-events/quickstart.md)).
